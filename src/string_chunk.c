...
//        return -1;
//    }
//    return ChunkGetSample(chunk, ((StringChunk *)chunk)->num_samples - 1).as->timestamp;
//}
//
...
//        return -1;
//    }
//    return ChunkGetSample(chunk, 0).as->timestamp;
//}
//
...
//        regChunk->base_timestamp = sample.as->timestamp;
//    }
//
...
//    timestamp_t ts = uCtx->sample.as.timestamp;
...
//        if (ts <= sample.as->timestamp) {
//            break;
//        }
//    }
//    // update value in case timestamp exists
//    if (sample != NULL && ts == sample.as->timestamp) {
...
//                                           int options,
//                                     StringChunkIterFuncs *retChunkIterClass) {
...
//}
//
//ChunkResult String_ChunkIteratorGetNext(StringChunkIter_t *iterator, StringSample *sample) {
